...
public class GatheringPlatformSerializer<T extends GatheringPlatformRecipe> implements RecipeSerializer<T> {

    private final Factory<T> factory;
    private final MapCodec<T> codec;
    private final StreamCodec<RegistryFriendlyByteBuf, T> streamCodec;

    public GatheringPlatformSerializer(Factory<T> factory) {
    ...
    public interface Factory<T extends GatheringPlatformRecipe> {
