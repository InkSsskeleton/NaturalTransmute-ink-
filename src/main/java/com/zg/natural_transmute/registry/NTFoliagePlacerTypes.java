...
public class NTFoliagePlacerTypes {
    ...
    public static final DeferredHolder<FoliagePlacerType<?>, FoliagePlacerType<EndAlsophilaPlacer>> END_ALSOPHILA = register("end_alsophila", EndAlsophilaPlacer.CODEC);
